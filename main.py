...
def translate():
    ...
    result = T.get('0.0','end')

    T.insert(tk.END, translator.translate(result, src='en', dest='hi'))
    T.insert(tk.END, "\n")
    T.insert(tk.END, "\n")
...
translate = tk.Button(master, text='Translate to Hindi', command=translate, width=14, height=1, bg='white', fg='black', font=('Times New Roman', 10)).place(x=925, y=390)
...
tk.Label(master, text="Varun Mohan Jha", bg='pink', font=('MV Boli', 11), width=70, height=1).grid(row=4, column=0,sticky=tk.W)
